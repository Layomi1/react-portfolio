...
const Header = () => {
  return (
    <div className="absolute bg-yellow w-full md:w-1/2  h-[70px] top-0 left-0 flex items-center pl-4 py-4  md:p-2  text-white font-semibold md:justify-around gap-6 md:gap-0 md:pr-7" >
